        ...
        <section className="Vision d-flex align-itemes-center justify-content-center" id="vision">
            <Container className=" mb-3 count">
                ...
                <Row className="mt-3 gy-4 ">
                    <Col lg={6}>
                        <div className="card1 ">
                            <img src="./assets/images/vision/vision1.jpg" alt="Rainbow Company" className='img1' />
                        </div>
                    </Col>
                    <Col lg={6}>
                        <div className="card2 text-center justify-content-center">
                            <p>
                                ما میکوشیم تا همانطور که مشتریان و تامین کنندگان از ما انتظار دارند. به عنوان بهترین تولید کننده محصولات رنگ در
                                 کشور و در سطح منطقه مصدر خدمت باشیم
                            </p>
                        </div>
                    </Col>
