...
function About (){
    ...
    <Container className=" my-3">
     ...
     <h2 className="mt-4">در باره ما</h2>
      </Row>
      ...
      <Row className="mt-3 gy-4">
        ...
        <Col lg={6}>
            <Card className="cardt text-center justify-content-center">
                ...
                ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، لورم ایپسوم متن ساختگی با تولنامفهوم از صنعت چاپ، و با استفاده از طراحان 
